    ...
    def __init__(
        ...
        *,  # Force keyword-only arguments
        ...
        def prepare_dataset(ds_name):
            ...
            # if ds_name != "droid":
            #     # Add dummy recording folderpath to my broken DROID datasets lol.
            ...
            cached_filter_dict_path = f"{data_dir}/{ds_name}/{version}/nonidle_ranges.json"
