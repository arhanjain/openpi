...
class LiberoRldsDataset:
    def __init__(
        ...
        *,  # Force keyword-only arguments
        ...
        builder = tfds.builder("embodied_features_and_demos_libero/libero_lm_90", data_dir=data_dir, version="1.0.0")
    ...
    def compute_len(self):
        ...
        dataset = tfds.load("embodied_features_and_demos_libero/libero_lm_90", data_dir="/gscratch/scrubbed/arhanj/datasets", split="train")
        total_steps = 0
        for entry in tqdm(dataset, desc="Counting steps..."):
            total_steps += len(entry["steps"])
        self.len = total_steps
...
if __name__ == "__main__":
    ...
    #     data_dir="/gscratch/scrubbed/arhanj/datasets",
    #     batch_size=16,
    #     shuffle=True,
    ...
    # for entry in tqdm(dataset, desc="Counting steps..."):
    #     total_steps += len(entry["steps"])
    # print(f"Total steps: {total_steps // 128}")